    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <label for="bidirectional" class="form-label mt-3">Rückführung:</label>
                    <div class="input-group mb-3">
                        <select class="form-control" id="bidirectional" v-model="params.bidirectional" required>
                            <option value="true">Ja</option>
                            <option value="false">Nein</option>
                        </select>
                        <button type="button" class="btn btn-outline-secondary" @click="toggleInfo('bidirectional')">?</button>
                    </div>
                    <div v-if="showingInfo === 'bidirectional'" class="form-text">
                        Erklärung für Rückführung...
                    </div>
                </div>

                <div class="col-12 col-lg-6">
                    <label for="sequenceLength" class="form-label mt-3">Sequenzlänge:</label>
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" id="sequenceLength" v-model="params.sequenceLength" required min="0" step="1">
                        <button type="button" class="btn btn-outline-secondary" @click="toggleInfo('sequenceLength')">?</button>
                    </div>
                    <div v-if="showingInfo === 'sequenceLength'" class="form-text">
                        Erklärung für Sequenzlänge...
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" class="form-control" id="batchSize" v-model="params.batchSize" required min="0" step="1">
                ...
                <div class="col-12 col-lg-6">
                    <label for="patience" class="form-label mt-3">Geduld (Patience):</label>
                    <div class="input-group mb-3">
...
export default {
    ...
    mounted() {
        ...
        if (this.parameters.bidirectional) {
            this.params.bidirectional = true
        }
        if (this.parameters.sequenceLength) {
            this.params.sequenceLength = this.parameters.sequenceLength
        }
