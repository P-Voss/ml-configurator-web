    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <label for="shrinking" class="form-label">Shrinking:</label>
                    <div class="input-group">
                        <select class="form-control" id="shrinking" v-model="params.shrinking" required>
                            <option value="true">Ja</option>
                            <option value="false">Nein</option>
                        </select>
                        <button type="button" class="btn btn-outline-secondary" @click="toggleInfo('shrinking')">?</button>
                    </div>
                    <div v-if="showingInfo === 'shrinking'" class="form-text">
                        Erklärung für Shrinking...
                    </div>
...
export default {
    ...
    mounted() {
        ...
        if (this.parameters.shrinking) {
            this.params.shrinking = "true"
        }
