<template>
    <div>
        <h3>Hyperparameter für logistische Regression</h3>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <label for="learningRate" class="form-label">Lernrate:</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="learningRate" v-model="params.learningRate" required step="0.01" min="0">
                ...
                <div class="col-12 col-lg-6">
                    <label for="maxIterations" class="form-label">Maximale Iterationen:</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="maxIterations" v-model="params.maxIterations" required step="1" min="5">
                ...
                <div class="col-12 col-lg-6">
                    <label for="tolerance" class="form-label">Toleranz:</label>
                    <div class="input-group">
                        <input type="number" class="form-control" id="tolerance" v-model="params.tolerance" required step="0.0001" min="0">
