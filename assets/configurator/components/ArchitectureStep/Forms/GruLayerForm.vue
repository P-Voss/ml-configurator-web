    ...
    <form @submit.prevent="handleSubmit">
        ...
        <div class="mb-3">
            ...
            <div v-if="showingInfo === 'units'" class="form-text">
                <p>
                    In GRU-Layern bezieht sich der Begriff 'Einheiten' auf die Anzahl der GRU-Zellen in der Schicht.
                    Jede Einheit enthält den Mechanismus des GRU, einschließlich der verschiedenen Gates.
        ...
        <div class="mb-3">
            ...
            <div v-if="showingInfo === 'returnSequences'" class="form-text">
                ...
                Dies ist besonders nützlich, wenn Sie eine zeitliche Abfolge an einen anderen GRU- oder rekurrenten Layer weitergeben möchten.
        ...
        <div class="mb-3">
            ...
            <div v-if="showingInfo === 'activation'" class="form-text">
                Definiert, wie die Ausgabe eines Neurons berechnet wird. Typischerweise wird Tanh für GRU-Aktivierungen verwendet.
        ...
        <button type="submit" class="btn btn-primary">GRU-Schicht hinzufügen</button>
